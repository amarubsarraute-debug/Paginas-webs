    ...
    <section id="inicio" ref={containerRef} className="relative" style={{ height: '300vh' }}>
      <div className="sticky top-0 h-dvh overflow-hidden bg-brand-dark">
        ...
        <div className="absolute inset-x-0 bottom-0 z-10 px-6 pb-28 md:px-14 md:pb-14 lg:px-20">
          ...
          >
            <span className="md:hidden">Medicina estética | Bienestar femenino</span>
            <span className="hidden md:inline">Medicina estética | Ginecología regenerativa y funcional</span>
          </motion.p>
          ...
          >
            Dra. Adriana
            <br />
            <em className="font-normal">Galleno</em>
          </motion.h1>
          ...
          >
            Resultados naturales, evaluación médica personalizada y bienestar femenino en Montevideo, Ciudad de la Costa y Punta del Este.
          </motion.p>
