          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            >
              <span className="relative inline-block text-ink z-10 font-extrabold mr-1">
                <span className="relative z-10">Electricista Andrés</span>
            ...
            >
              ...
              <a
                href="tel:+59893381464" // Usamos el número de teléfono del cliente de la landing
            ...
            >
              <span className="text-star text-sm tracking-widest">★★★★★</span> <span>5.0 / Reseñas en Google (5 opiniones)</span>
