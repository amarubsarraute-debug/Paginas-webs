  ...
  const services = [
    {
      ...
      waMessage: "Hola Barceló instalaciones eléctricas, me gustaría consultar por *Instalaciones y Obras*."
    },
    {
      index: "02",
      ...
      waMessage: "Hola Barceló instalaciones eléctricas, necesito información sobre *Tableros y Normalización*."
    },
    {
      index: "03",
      ...
      waMessage: "Hola Barceló instalaciones eléctricas, quiero cotizar un trabajo de *Iluminación y Reformas*."
    },
    {
      index: "04",
      ...
      waMessage: "Hola Barceló instalaciones eléctricas, necesito un servicio de *Mantenimiento y Reparación* por una falla."
    }
  ];
