...
export function Gallery() {
  const images = [
    {
      src: "./img/03-obra-instalacion-subterranea.png",
      alt: "Canalización subterránea y tendido de cables de acometida",
      tag: "Obras"
    },
    {
      src: "./img/04-control-acceso-intelbras.png",
      alt: "Instalación de sistema de control de acceso Intelbras",
      tag: "Instalaciones"
    },
    {
      src: "./img/05-tablero-electrico-organizado.png",
      alt: "Armado, cableado y peinado de tablero general de distribución",
      tag: "Tableros"
    },
    {
      src: "./img/06-medidores-exteriores.png",
      alt: "Montaje de medidores de energía en pilar exterior",
      tag: "Instalaciones"
    },
    {
      src: "./img/07-sala-de-medidores-y-distribucion.png",
      alt: "Montaje de sala de medidores múltiples para complejo comercial",
      tag: "Obras"
    },
    {
      src: "./img/08-selfie-profesional-con-tablero.png",
      alt: "Instalación, rotulado y pruebas de funcionamiento del sistema",
      tag: "Tableros"
    }
  ];
