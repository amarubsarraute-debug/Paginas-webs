          ...
          <div className="lg:col-span-5 space-y-6 text-left">
            ...
            >
              <span className="relative inline-block text-ink z-10 font-extrabold mr-1">
                <span className="relative z-10">Barceló instalaciones eléctricas</span>
          ...
          <div className="lg:col-span-7 relative flex justify-center z-10 w-full">
            ...
            >
              ...
              <div className="relative aspect-[3/2] rounded-3xl overflow-hidden bg-bg-tint border border-border-subtle shadow-2xl">
                <img
                  src="./img/09-home-barcelo.jpg"
                  alt="Servicios de Barceló instalaciones eléctricas en Maldonado"
