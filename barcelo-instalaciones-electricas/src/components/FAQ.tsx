...
export function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Barceló instalaciones eléctricas posee firma autorizada técnica por UTE hasta 50 kW. Esto incluye el armado, presentación y aprobación de carpetas técnicas residenciales, comerciales e industriales medianas."
    },
    {
