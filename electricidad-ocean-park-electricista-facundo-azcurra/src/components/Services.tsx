  ...
  const services = [
    {
      ...
      waMessage: "Hola Electricidad Ocean Park - Electricista Facundo Azcurra, me gustaría consultar por *Instalaciones y Obras*."
    },
    {
      index: "02",
      ...
      waMessage: "Hola Electricidad Ocean Park - Electricista Facundo Azcurra, necesito información sobre *Tableros y Normalización*."
    },
    {
      index: "03",
      ...
      waMessage: "Hola Electricidad Ocean Park - Electricista Facundo Azcurra, quiero cotizar un trabajo de *Iluminación y Reformas*."
    },
    {
      index: "04",
      ...
      waMessage: "Hola Electricidad Ocean Park - Electricista Facundo Azcurra, necesito un servicio de *Mantenimiento y Reparación* por una falla."
    }
  ];
