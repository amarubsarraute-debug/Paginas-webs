...
export function FAQ() {
  const faqs = [
    {
      q: "¿Atienden emergencias eléctricas en Maldonado?",
      a: "Sí, contamos con atención de urgencias y brigada móvil en Maldonado, Punta del Este, San Rafael, Aidy Grill, La Barra, Pinares y zonas aledañas."
    },
    {
      q: "¿Qué tipo de trabajos y garantías ofrecen?",
      a: "Electricidad Ocean Park - Electricista Facundo Azcurra posee firma autorizada técnica por UTE hasta 50 kW. Esto incluye el armado, presentación y aprobación de carpetas técnicas residenciales, comerciales e industriales medianas."
    },
    {
