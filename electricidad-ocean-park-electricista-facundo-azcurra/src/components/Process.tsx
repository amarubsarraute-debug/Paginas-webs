...
export function Process() {
  const steps = [
    ...
    {
      number: "03",
      title: "Trabajo bajo normativas de seguridad",
      text: "Ejecutamos el proyecto con prolijidad, seguridad y responsabilidad, entregando carpetas de habilitación de UTE firmadas al día."
    }
  ];
