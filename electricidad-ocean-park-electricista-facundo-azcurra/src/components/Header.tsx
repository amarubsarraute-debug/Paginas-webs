...
import logoOceanPark from "../assets/logo-ocean-park.png";
        ...
        <div className="h-16 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-2 shrink-0">
            <div className="flex items-center gap-2.5">
              <Lightbulb className="w-6 h-6 text-gold shrink-0" strokeWidth={1.5} />
              <span className="text-sm font-extrabold text-ink tracking-tight font-display flex flex-col leading-none text-left font-sans">
                <span className="font-extrabold">ELECTRICIDAD</span>
                <span className="text-[9px] font-semibold text-gold tracking-widest mt-0.5">OCEAN PARK</span>
              </span>
            </div>
          </a>
