      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            >
              <span className="relative inline-block text-ink z-10 font-extrabold mr-1">
                <span className="relative z-10">Juan carlos Martínez electricidad</span>
            ...
            >
              ...
              <a
                href="tel:+59897465040" // Usamos el número de teléfono del cliente de la landing
          ...
          <div className="lg:col-span-5 relative flex justify-center z-10">
            ...
            >
              {/* Photo Frame */}
              <div className="relative aspect-square rounded-3xl overflow-hidden bg-bg-tint border border-border-subtle shadow-2xl">
                <img
                  src="./img/tablero-despues-juan-carlos.png"
                  alt="Tablero eléctrico normalizado por Juan Carlos Martínez Electricidad"
