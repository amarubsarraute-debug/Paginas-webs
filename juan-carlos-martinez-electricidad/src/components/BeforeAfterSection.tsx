      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 w-full flex justify-center order-2 lg:order-1">
            ...
            >
              <BeforeAfter
                beforeSrc="./img/tablero-antes-juan-carlos.png"
                afterSrc="./img/tablero-despues-juan-carlos.png"
          ...
          <div className="lg:col-span-6 space-y-6 order-1 lg:order-2 text-left">
            ...
            <p className="text-muted text-base sm:text-lg font-light leading-relaxed">
              Mirá el cambio real de un trabajo de normalización de Juan carlos Martínez electricidad. De un cableado caótico y propenso a recalentamientos, a un tablero ordenado, seguro y certificado bajo normativas de seguridad.
            </p>
