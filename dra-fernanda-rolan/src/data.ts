export const GOOGLE_REVIEW_LINK = "https://www.google.com/maps/search/?api=1&query=Dra.%20Fernanda%20Rol%C3%A1n%20-%20Harmoniza%C3%A7%C3%A3o%20Facial%20Chuy%20%2F%20Chu%C3%AD";
export const WHATSAPP_NUMBER_1 = "59899000000";
export const WHATSAPP_NUMBER_2 = "59899000000";
export const WHATSAPP_MESSAGE = "Hola Dra. Fernanda Rolán, quiero agendar una consulta.";

export const FAQS = [
  {
    question: "¿Los resultados se ven naturales?",
    answer: "El enfoque de Dra. Fernanda Rolán prioriza la naturalidad, la armonía y la conservación de la expresión. Cada tratamiento se indica según evaluación personalizada."
  },
  {
...
export const LOCATIONS = [
  {
    id: "consultorio",
    name: "Dra. Fernanda Rolán - Frontera",
    day: "Lunes a Viernes",
    time: "9:00 a 18:00 hs",
    address: "Frontera, Chuy / Chuí, Uruguay",
    button: "Agendar Consulta",
    mapEmbedUrl: "https://www.google.com/maps?q=Frontera%2C%20Chuy%20%2F%20Chu%C3%AD%2C%20Uruguay&output=embed"
  }
];
