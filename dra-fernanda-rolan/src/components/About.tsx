        ...
        <div className="grid items-center gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:gap-16">
          ...
          >
            <div className="relative">
              ...
              <div className="relative z-10 overflow-hidden rounded-sm border border-brand-sand-light/15 bg-brand-sand-light/10 shadow-xl shadow-black/10">
                <img
                  src={doctorPhoto}
                  alt="Dra. Fernanda Rolán en consultorio"
          ...
          >
            ...
            <div className="space-y-5 text-base leading-relaxed text-brand-sand-light/76 md:text-lg">
              <p className="text-xl leading-relaxed text-brand-sand-light/92">Médica especializada en Medicina Estética y cuidado integral.</p>
...
<p>Cuento con formación especializada en técnicas médico-estéticas avanzadas y me mantengo en constante capacitación para ofrecerte protocolos eficaces y de vanguardia en Chuy / Chuí.</p>
