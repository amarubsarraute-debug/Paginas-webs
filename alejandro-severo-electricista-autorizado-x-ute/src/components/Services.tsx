  ...
  const services = [
    {
      ...
      waMessage: "Hola Alejandro Severo, me gustaría consultar por *Instalaciones y Obras*."
    },
    {
      index: "02",
      ...
      waMessage: "Hola Alejandro Severo, necesito información sobre *Tableros y Firma de UTE*."
    },
    {
      index: "03",
      ...
      waMessage: "Hola Alejandro Severo, quiero cotizar un trabajo de *Iluminación y Reformas*."
    },
    {
      index: "04",
      ...
      waMessage: "Hola Alejandro Severo, necesito un servicio de *Mantenimiento y Reparación* por una falla."
    }
  ];
