        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            >
              ...
              <span>Montevideo • Firma Autorizada UTE</span>
            </motion.div>
            ...
            >
              <span className="relative inline-block text-ink z-10 font-extrabold mr-1">
                <span className="relative z-10">Alejandro Severo</span>
                <span className="absolute left-0 right-0 bottom-[2px] h-[0.25em] bg-gold-soft rounded-sm -z-10" />
              </span> realiza trabajos residenciales, comerciales y obras autorizado por UTE. <b>Respuestas rápidas, diagnósticos transparentes y trámites al día.</b>
            </motion.p>
            ...
            >
              ...
              <a
                href="tel:+59898972547" // Usamos el número de teléfono del cliente de la landing
            ...
            >
              <span className="text-gold font-bold">✓</span> <span>Servicio Garantizado</span>
          ...
          <div className="lg:col-span-5 relative flex justify-center z-10">
            ...
            >
              ...
              <div className="relative aspect-[1/1.05] rounded-3xl overflow-hidden bg-bg-tint border border-border-subtle shadow-2xl">
                <img
                  src="./img/06-tecnico-trabajando-en-caja-electrica-exterior.png"
                  alt="Técnico electricista Alejandro Severo trabajando en tablero exterior"
