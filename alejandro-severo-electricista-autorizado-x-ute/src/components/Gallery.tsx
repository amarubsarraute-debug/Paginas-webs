...
export function Gallery() {
  const images = [
    {
      src: "./img/01-iluminacion-exterior-en-casa-de-ladrillo.png",
      alt: "Iluminación exterior en casa de ladrillo",
      tag: "Exteriores"
    },
    {
      src: "./img/02-iluminacion-de-fachada-urbana-nocturna.png",
      alt: "Iluminación decorativa nocturna de fachada",
      tag: "Iluminación"
    },
    {
      src: "./img/03-trabajo-electrico-en-panel-exterior.png",
      alt: "Conexión de tableros y paneles eléctricos",
      tag: "Instalaciones"
    },
    {
      src: "./img/04-iluminacion-en-vestidor-moderno.png",
      alt: "Iluminación LED indirecta en vestidor",
      tag: "Iluminación"
    },
    {
      src: "./img/05-iluminacion-lineal-en-oficina-moderna.png",
      alt: "Luminarias lineales LED en oficina",
      tag: "Comercial"
    },
    {
      src: "./img/trabajos-alejandro-final/alejandro-trabajo-real-04-feria-buceo-cartel.jpg",
      alt: "Obra eléctrica y cartel de la Feria Nocturna del Buceo",
      tag: "Comercial"
    }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        ...
        <div className="max-w-2xl mb-16 space-y-4">
          ...
          <p className="text-muted text-base sm:text-lg font-light leading-relaxed max-w-[65ch]">
            Una selección de instalaciones, iluminación y proyectos ejecutados en Montevideo. Fotos reales de trabajos reales.
          </p>
        </div>
