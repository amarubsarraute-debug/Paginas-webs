...
export function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Electricidad Amaral ofrece total garantía en todos sus trabajos. Nos aseguramos de realizar instalaciones prolijas, seguras y duraderas utilizando materiales normalizados."
    },
    {
