        ...
        <div className="bg-paper rounded-3xl border border-border-subtle p-8 sm:p-12 lg:p-16 flex flex-col lg:flex-row gap-12 items-center shadow-lg">
          ...
          <div className="lg:w-1/2 space-y-6">
            ...
            <p className="text-base sm:text-lg text-muted font-light leading-relaxed">
              Soluciones Eléctricas EP ofrece el respaldo profesional necesario para realizar instalaciones, reformas y mantenimiento con total seguridad. No hacemos arreglos provisorios; trabajamos bajo normativas vigentes para asegurar la durabilidad y seguridad de tu hogar o comercio.
            </p>
          </div>
