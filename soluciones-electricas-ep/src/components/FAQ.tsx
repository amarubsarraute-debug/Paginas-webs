  ...
  const faqs = [
    {
      ...
      a: "Sí, contamos con atención de urgencias y brigada móvil en barrios como Costa de Oro y toda la zona de Canelones y zonas aledañas."
    },
    {
      q: "¿Realizan trabajos con garantía?",
      a: "Soluciones Eléctricas EP ofrece total garantía en todos sus trabajos. Nos aseguramos de realizar instalaciones prolijas, seguras y duraderas utilizando materiales normalizados."
    },
    {
