export const GOOGLE_REVIEW_LINK = "https://www.google.com/maps/search/?api=1&query=Dr.%20Mat%C3%ADas%20Alcaraz%20-%20Medicina%20Est%C3%A9tica%20Montevideo";
export const WHATSAPP_NUMBER_1 = "59899000000";
export const WHATSAPP_NUMBER_2 = "59899000000";
export const WHATSAPP_MESSAGE = "Hola Dr. Matías Alcaraz, quiero agendar una consulta.";

export const FAQS = [
  {
    question: "¿Los resultados se ven naturales?",
    answer: "El enfoque de Dr. Matías Alcaraz prioriza la naturalidad, la armonía y la conservación de la expresión. Cada tratamiento se indica según evaluación personalizada."
  },
  {
...
export const LOCATIONS = [
  {
    id: "consultorio",
    name: "Dr. Matías Alcaraz - Tres Cruces / Parque Batlle",
    day: "Lunes a Viernes",
    time: "9:00 a 18:00 hs",
    address: "Tres Cruces / Parque Batlle, Montevideo, Uruguay",
    button: "Agendar Consulta",
    mapEmbedUrl: "https://www.google.com/maps?q=Tres%20Cruces%20%2F%20Parque%20Batlle%2C%20Montevideo%2C%20Uruguay&output=embed"
  }
];
