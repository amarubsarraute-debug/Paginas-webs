      ...
      <div className="sticky top-0 h-dvh overflow-hidden bg-brand-dark">
        ...
        <div className="absolute inset-x-0 bottom-0 z-10 px-6 pb-28 md:px-14 md:pb-14 lg:px-20">
          ...
          >
            Dr. Matías
            <br />
            <em className="font-normal">Alcaraz</em>
          </motion.h1>
          ...
          >
            Resultados naturales, evaluación médica personalizada y tratamientos estéticos de vanguardia en Montevideo (Tres Cruces / Parque Batlle).
          </motion.p>
