...
export function CTA() {
  return (
    <section className="py-20 bg-gradient-to-br from-navy via-brand-blue to-brand-blue-deep text-white relative overflow-hidden z-10">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
          ...
          <div className="text-left space-y-4 lg:max-w-2xl">
            <span className="inline-block font-mono text-xs font-bold tracking-widest text-gold-bright uppercase">
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-3 w-full lg:w-auto shrink-0">
            <a
              href="tel:+59891339311"
              className="w-full sm:w-auto px-8 py-4 bg-gold hover:bg-gold-bright text-navy font-bold rounded-xl shadow-xl hover:-translate-y-0.5 transition-all text-center flex items-center justify-center gap-2"
            >
