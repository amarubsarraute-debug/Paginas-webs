...
export function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-paper/85 backdrop-blur-md border-b border-border-subtle">
      <div className="mx-auto w-full max-w-[100vw] px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
        <div className="mobile-safe-row h-20 flex items-center justify-between">
          
          {/* Logo / Brand */}
          <a href="#" className="flex items-center shrink-0" aria-label="Electropunta inicio">
            <img
              src="./img/electropunta-logo-wordmark.svg"
              alt="Electropunta Soluciones Electricas"
              className="h-12 w-[185px] sm:h-14 sm:w-[285px] lg:w-[335px] object-contain object-left"
            />
          </a>
          ...
          <div className="flex items-center gap-5">
            ...
            <nav className="hidden lg:flex items-center gap-6 font-mono text-xs font-semibold text-muted">
            ...
            <a 
              ...
              className="inline-flex h-10 w-10 sm:h-auto sm:w-auto items-center justify-center gap-1.5 p-0 sm:px-4 sm:py-2 border border-gold/30 hover:border-gold rounded-xl text-xs font-bold text-ink bg-gold/10 hover:bg-gold/20 transition-all duration-200"
            >
