  ...
  const services = [
    {
      ...
      waMessage: "Hola Electropunta, me gustaría consultar por *Instalaciones y Obras*."
    },
    {
      index: "02",
      ...
      waMessage: "Hola Electropunta, necesito información sobre *Tableros y Normalización*."
    },
    {
      index: "03",
      ...
      waMessage: "Hola Electropunta, quiero cotizar un trabajo de *Iluminación y Reformas*."
    },
    {
      index: "04",
      ...
      waMessage: "Hola Electropunta, necesito un servicio de *Mantenimiento y Reparación* por una falla."
    }
  ];
