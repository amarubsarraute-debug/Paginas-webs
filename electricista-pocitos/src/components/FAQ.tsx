  ...
  const faqs = [
    {
      ...
      a: "Sí, contamos con atención de urgencias y brigada móvil en barrios como Pocitos y zonas aledañas y zonas aledañas."
    },
    {
      q: "¿Realizan trabajos con garantía?",
      a: "Pocitos Electricidad ofrece total garantía en todos sus trabajos. Nos aseguramos de realizar instalaciones prolijas, seguras y duraderas utilizando materiales normalizados."
    },
    {
