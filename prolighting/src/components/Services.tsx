  ...
  const services = [
    {
      ...
      waMessage: "Hola Prolighting, me gustaría consultar por *Instalaciones y Obras*."
    },
    {
      index: "02",
      ...
      waMessage: "Hola Prolighting, necesito información sobre *Tableros y Normalización*."
    },
    {
      index: "03",
      ...
      waMessage: "Hola Prolighting, quiero cotizar un trabajo de *Iluminación y Reformas*."
    },
    {
      index: "04",
      ...
      waMessage: "Hola Prolighting, necesito un servicio de *Mantenimiento y Reparación* por una falla."
    }
  ];
