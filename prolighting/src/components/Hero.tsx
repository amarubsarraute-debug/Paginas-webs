      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 space-y-6 text-left">
            ...
            >
              <span className="relative inline-block text-ink z-10 font-extrabold mr-1">
                <span className="relative z-10">Prolighting</span>
                <span className="absolute left-0 right-0 bottom-[2px] h-[0.25em] bg-gold-soft rounded-sm -z-10" />
              </span>{" "}
              realiza trabajos residenciales, comerciales y obras con respaldo técnico hasta 50 kW. <b>Respuestas rápidas, presupuestos claros y carpetas de habilitación de UTE al día.</b>
            </motion.p>
          ...
          <div className="lg:col-span-7 relative flex justify-center z-10 w-full">
            ...
            >
              {/* Photo Frame */}
              <div className="relative aspect-[16/9] rounded-3xl overflow-hidden bg-navy/20 border border-border-subtle shadow-2xl">
                <img
                  src="./img/07-home-terminado.png"
                  alt="Casa moderna iluminada por Prolighting en Maldonado"
