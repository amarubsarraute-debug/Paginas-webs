        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            >
              ...
              <span>Canelones • Firma Autorizada UTE</span>
            </motion.div>
            ...
            >
              <span className="relative inline-block text-ink z-10 font-extrabold mr-1">
                <span className="relative z-10">Marcelo Tu Electricista UY</span>
            ...
            >
              ...
              <a
                href="tel:+59897986044" // Usamos el número de teléfono del cliente de la landing
            ...
            >
              <span className="text-star text-sm tracking-widest">★★★★★</span> <span>4.9 / Reseñas en Google (27 opiniones)</span>
            ...
            >
              ...
              <div className="relative aspect-[1/1.05] rounded-3xl overflow-hidden bg-bg-tint border border-border-subtle shadow-2xl">
                <img
                  ...
                  alt="Retrato de Marcelo Tu Electricista UY en Maldonado"
