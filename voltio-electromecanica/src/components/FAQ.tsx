  ...
  const faqs = [
    {
      ...
      a: "Sí, contamos con atención de urgencias y brigada móvil en barrios como Canelones y toda la zona de Canelones y zonas aledañas."
    },
    {
      q: "¿Realizan trabajos con garantía?",
      a: "Voltio Electromecánica ofrece total garantía en todos sus trabajos. Nos aseguramos de realizar instalaciones prolijas, seguras y duraderas utilizando materiales normalizados."
    },
    {
