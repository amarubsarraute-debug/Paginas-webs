export const GOOGLE_REVIEW_LINK = "https://www.google.com/maps/search/?api=1&query=Cl%C3%ADnica%20Dra.%20Magali%20Chaparro%20Montevideo";
export const WHATSAPP_NUMBER_1 = "59898293590";
export const WHATSAPP_NUMBER_2 = "59898293590";
export const WHATSAPP_MESSAGE = "Hola Dra. Magalí Chaparro, quiero agendar una consulta.";

export const FAQS = [
  {
    question: "¿Los resultados se ven naturales?",
    answer: "El enfoque de Dra. Magalí Chaparro prioriza la naturalidad, la armonía y la conservación de la expresión. Cada tratamiento se indica según evaluación personalizada."
  },
  {
...
export const REVIEW_SLOTS = [
  {
    ...
    "text": "Excelente atención, profesionales muy cálidos y recomendables. Un trato humano que hoy en día se valora muchísimo."
  },
  {
    "title": "Juan Manuel Pérez",
    "text": "Excelente trato y atención de primera. Recomiendo la clínica totalmente por su puntualidad y dedicación."
  }
];
...
export const LOCATIONS = [
  {
    id: "consultorio",
    name: "Dra. Magalí Chaparro - Centro",
    day: "Lunes a Viernes",
    time: "9:00 a 18:00 hs",
    address: "Centro, Montevideo, Uruguay",
    button: "Agendar Consulta",
    mapEmbedUrl: "https://www.google.com/maps?q=Centro%2C%20Montevideo%2C%20Uruguay&output=embed"
  }
];
