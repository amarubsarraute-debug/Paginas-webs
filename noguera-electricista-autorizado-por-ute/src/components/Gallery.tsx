...
export function Gallery() {
  const images = [
    {
      src: "./img/01_carga_electrica_auto.png",
      alt: "Instalación de cargador de vehículos eléctricos en garage",
      tag: "Instalaciones"
    },
    {
      src: "./img/02_caja_electrica.png",
      alt: "Tendido y peinado de conductores en tablero general",
      tag: "Tableros"
    },
    {
      src: "./img/03_iluminacion_exterior_edificio.png",
      alt: "Diseño y montaje de iluminación decorativa exterior",
      tag: "Iluminación"
    },
    {
      src: "./img/04_detalle_lampara_jardin.png",
      alt: "Colocación de luminarias estancas para senderos de jardín",
      tag: "Exteriores"
    }
  ];
