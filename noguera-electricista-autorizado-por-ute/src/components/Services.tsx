  ...
  const services = [
    {
      ...
      waMessage: "Hola Noguera - Electricista autorizado por UTE, me gustaría consultar por *Instalaciones y Obras*."
    },
    {
      index: "02",
      ...
      waMessage: "Hola Noguera - Electricista autorizado por UTE, necesito información sobre *Tableros y Firma de UTE*."
    },
    {
      index: "03",
      ...
      waMessage: "Hola Noguera - Electricista autorizado por UTE, quiero cotizar un trabajo de *Iluminación y Reformas*."
    },
    {
      index: "04",
      ...
      waMessage: "Hola Noguera - Electricista autorizado por UTE, necesito un servicio de *Mantenimiento y Reparación* por una falla."
    }
  ];
