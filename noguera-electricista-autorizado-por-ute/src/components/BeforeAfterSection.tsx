      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 w-full flex justify-center order-2 lg:order-1">
            ...
            >
              <BeforeAfter
                beforeSrc="./img/tablero-antes-noguera.png"
                afterSrc="./img/tablero-despues-noguera.png"
                alt="Tablero eléctrico normalizado por Noguera - Electricista autorizado por UTE"
              />
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-6 space-y-6 order-1 lg:order-2 text-left">
            ...
            <p className="text-muted text-base sm:text-lg font-light leading-relaxed">
              Mirá el cambio real de un trabajo de normalización de Noguera - Electricista autorizado por UTE. De un cableado caótico y propenso a recalentamientos, a un tablero ordenado, seguro y certificado bajo normas UTE.
            </p>
