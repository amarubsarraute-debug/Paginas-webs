        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            >
              ...
              <span>Maldonado • Punta del Este • Firma Autorizada UTE</span>
            </motion.div>
            ...
            >
              <span className="relative inline-block text-ink z-10 font-extrabold mr-1">
                <span className="relative z-10">Noguera - Electricista autorizado por UTE</span>
            ...
            >
              ...
              <a
                href="tel:+59898599609" // Usamos el número de teléfono del cliente de la landing
          ...
          <div className="lg:col-span-5 relative flex justify-center z-10">
            ...
            >
              {/* Photo Frame */}
              <div className="relative aspect-[4/5] rounded-3xl overflow-hidden bg-bg-tint border border-border-subtle shadow-2xl">
                <img
                  src="./img/home-tablero-exterior-noguera.png"
                  alt="Tablero exterior instalado por Noguera - Electricista autorizado por UTE en Maldonado"
