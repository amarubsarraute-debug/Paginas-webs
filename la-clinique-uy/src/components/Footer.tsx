      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <img
              src={logo}
              alt="Logo La Clinique Medicina Estética"
          ...
          <div>
            <h4 className="font-medium text-lg mb-6">Ubicación</h4><ul className="space-y-3 text-brand-sand-light/70 text-sm"><li>Playa Mansa, Punta del Este</li></ul>
          </div>

          <div>
            <h4 className="font-medium text-lg mb-6">Contacto</h4>
            <ul className="space-y-3 text-brand-sand-light/70 text-sm">
              <li><a href={whatsappUrl1} className="hover:text-brand-gold transition-colors">WhatsApp: 092 870 728</a></li>
        ...
        <div className="pt-8 border-t border-brand-sand-light/10 text-center md:text-left text-xs text-brand-sand-light/55 flex flex-col md:flex-row justify-between gap-4">
          <p>© {currentYear} La Clinique - Salud & Bienestar. Todos los derechos reservados.</p>
