      ...
      <div className="sticky top-0 h-dvh overflow-hidden bg-brand-dark">
        ...
        <div className="absolute inset-x-0 bottom-0 z-10 px-6 pb-28 md:px-14 md:pb-14 lg:px-20">
          ...
          >
            La
            <br />
            <em className="font-normal">Clinique</em>
          </motion.h1>
          ...
          >
            Resultados naturales, evaluación médica personalizada y tratamientos estéticos de vanguardia en Punta del Este (Playa Mansa).
          </motion.p>
