export const GOOGLE_REVIEW_LINK = "https://www.google.com/maps/search/?api=1&query=Mint%20Cl%C3%ADnica%20-%20Odontolog%C3%ADa%20y%20Est%C3%A9tica%20Facial%20Montevideo";
export const WHATSAPP_NUMBER_1 = "59899000000";
export const WHATSAPP_NUMBER_2 = "59899000000";
export const WHATSAPP_MESSAGE = "Hola Mint Clínica, quiero agendar una consulta.";

export const FAQS = [
  {
    question: "¿Los resultados se ven naturales?",
    answer: "El enfoque de Mint Clínica prioriza la naturalidad, la armonía y la conservación de la expresión. Cada tratamiento se indica según evaluación personalizada."
  },
  {
...
export const LOCATIONS = [
  {
    id: "consultorio",
    name: "Mint Clínica - Pocitos",
    day: "Lunes a Viernes",
    time: "9:00 a 18:00 hs",
    address: "Pocitos, Montevideo, Uruguay",
    button: "Agendar Consulta",
    mapEmbedUrl: "https://www.google.com/maps?q=Pocitos%2C%20Montevideo%2C%20Uruguay&output=embed"
  }
];
