          ...
          >
            <div className="relative">
              ...
              <div className="relative z-10 overflow-hidden rounded-sm border border-brand-sand-light/15 bg-brand-sand-light/10 shadow-xl shadow-black/10">
                <img
                  src={doctorPhoto}
                  alt="Mint Clínica - Odontología y Estética Facial en consultorio"
...
<p>Contamos con profesionales altamente capacitados y equipamiento de vanguardia para ofrecerte los tratamientos más eficaces y seguros del mercado en Montevideo.</p>
