...
export function FAQ() {
  const faqs = [
    {
      q: "¿Atienden emergencias eléctricas en Montevideo?",
      a: "Sí, contamos con atención de urgencias y brigada móvil en toda la zona de Montevideo y zonas aledañas."
    },
    {
      q: "¿Qué alcance tiene su firma técnica de UTE?",
      a: "Electricistas Urgencias posee firma autorizada técnica por UTE hasta 50 kW. Esto incluye el armado, presentación y aprobación de carpetas técnicas residenciales, comerciales e industriales medianas."
    },
    {
