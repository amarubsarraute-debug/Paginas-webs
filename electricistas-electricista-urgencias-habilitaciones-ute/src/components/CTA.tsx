        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
          ...
          <div className="text-left space-y-4 lg:max-w-2xl">
            ...
            <p className="text-white/80 text-base sm:text-lg font-light leading-relaxed">
              ¿Salta la térmica, hay olor a quemado o te quedaste sin luz? Respondemos de forma inmediata. Contamos con brigada móvil lista para salir en Montevideo.
            </p>
          </div>
