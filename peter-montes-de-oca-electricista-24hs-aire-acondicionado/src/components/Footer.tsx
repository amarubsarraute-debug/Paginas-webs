    ...
    <footer className="bg-bg-tint pt-20 pb-10 border-t border-border-subtle z-10 relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 text-left">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-extrabold text-ink tracking-tight font-display">Peter Montes de Oca<b>.</b><small className="block text-[10px] font-mono font-bold uppercase tracking-wider text-muted mt-1">Técnico Electricista</small></span>
            </div>
        ...
        <div className="pt-8 border-t border-border-subtle flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-xs text-muted">
          <p className="">
            &copy; {new Date().getFullYear()} Peter Montes de Oca - Electricista 24 hs. - Aire acondicionado. Todos los derechos reservados.
          </p>
