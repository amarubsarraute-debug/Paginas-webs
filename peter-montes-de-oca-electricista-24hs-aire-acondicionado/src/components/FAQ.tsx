...
export function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Peter Montes de Oca ofrece total garantía en todos sus trabajos. Nos aseguramos de realizar instalaciones prolijas, seguras y duraderas utilizando materiales normalizados."
    },
    {
