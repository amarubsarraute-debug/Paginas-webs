          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            >
              <span className="relative inline-block text-ink z-10 font-extrabold mr-1">
                <span className="relative z-10">Hernández Electricista</span>
            ...
            >
              ...
              <a
                href="tel:+59893783551" // Usamos el número de teléfono del cliente de la landing
            ...
            >
              <span className="text-star text-sm tracking-widest">★★★★★</span> <span>5.0 / Reseñas en Google (16 opiniones)</span>
            ...
            >
              ...
              <div className="relative aspect-[1/1.05] rounded-3xl overflow-hidden bg-bg-tint border border-border-subtle shadow-2xl">
                <img
                  ...
                  alt="Retrato de Hernández Electricista en Maldonado"
