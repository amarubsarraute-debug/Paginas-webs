  ...
  const problems = [
    {
      ...
      waMessage: "Hola Hernández Electricista, me salta la térmica constantemente y necesito que un técnico revise la instalación."
    },
    {
      icon: LightbulbOff,
      ...
      waMessage: "Hola Hernández Electricista, tengo parpadeo de luces y variaciones de tensión en mi propiedad."
    },
    {
      icon: Flame,
      ...
      waMessage: "Hola Hernández Electricista, siento olor a quemado / escucho chispazos y necesito asistencia urgente."
    },
    {
      icon: Plug,
      ...
      waMessage: "Hola Hernández Electricista, necesito reparar o cambiar unos enchufes, llaves o teclas defectuosas."
    },
    {
      icon: FileSignature,
      ...
      waMessage: "Hola Hernández Electricista, necesito un electricista para cotizar un cambio de llaves térmicas o normalización."
    },
    {
      icon: AlertTriangle,
      ...
      waMessage: "Hola Hernández Electricista, quiero cotizar la adecuación y cableado a tierra de una instalación antigua."
    }
  ];

  const buildWaUrl = (message: string) => {
    return `https://wa.me/59893783551?text=${encodeURIComponent(message)}`;
  };
    ...
    <section id="problemas" className="py-24 border-b border-border-subtle relative z-10 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        ...
        <div className="mt-16 bg-bg-tint/40 rounded-3xl border border-border-subtle p-8 sm:p-10 flex flex-col md:flex-row gap-8 items-center justify-between shadow-sm">
          ...
          <a
            href="https://wa.me/59893783551?text=Hola%20Silvera%20Electricidad,%20tengo%20una%20consulta%20por%20un%20trabajo%20el%C3%A9ctrico%20que%20no%20figura%20en%20la%20lista."
            target="_blank"
            rel="noopener noreferrer"
