...
export function Clients() {
  ...
  const reviews = [
    {
      quote: "Hace unos días me instaló el cargador para el auto eléctrico. Muy buena disposición, nos ayudó a elegir el mejor lugar para ubicar el dispositivo y, de yapa, nos dio una mano con el asesoramiento del cambio de tarifa de UTE, algo muy necesario en estos casos. Recomiendo ampliamente su trabajo.",
      author: "Lucía Fagetti",
      service: "Cargador Auto Eléctrico",
      isFeatured: true
    },
    {
      quote: "Tuvimos una emergencia y nos quedamos sin luz en casa. A los 10 o 15 minutos Milton apareció, puso el repuesto necesario y lo arregló. El precio fue acorde al trabajo. Un genio, para destacar y tenerlo agendado. Gracias, Milton, aprecio mucho tu profesionalismo.",
      author: "Haygustos Quemerecen",
      service: "Urgencia Eléctrica",
      isFeatured: false
    },
    {
      quote: "Llamé a Milton un sábado de tarde por una falla eléctrica y el domingo de mañana vino y me solucionó el problema. Hizo un muy buen trabajo, buscando las mejores alternativas y explicando paso a paso lo que había que hacer. Es un técnico súper recomendable. Muy responsable, serio y cumplidor.",
      author: "Martín Vallcorba",
      service: "Falla Eléctrica",
      isFeatured: false
    },
    {
      quote: "Excelente electricista y, más importante aún, excelente persona. Siempre bien dispuesto, de buen humor y muy educado. Lo recomiendo 100%. Si precisan un electricista, no duden en llamar a Milton.",
      author: "Gabriela Monreal",
      service: "Instalación Residencial",
      isFeatured: false
    },
    {
      quote: "¡Muy recomendable! Me asesoró y resolvió todo impecable. Muy buena onda también, que eso siempre suma.",
      author: "Santiago Firpo",
      service: "Asesoramiento UTE",
      isFeatured: false
    },
    {
      quote: "Excelente servicio, puntual, rápido y con mucha voluntad de reparar. Muy recomendable.",
      author: "Juan Miguel Leivas Serron",
      service: "Reparación Eléctrica",
      isFeatured: false
    },
    {
      quote: "Muy recomendable Milton. Correcto y cumplidor, tanto en lo técnico como en lo profesional.",
      author: "Fabian Vico",
      service: "Servicio Técnico",
      isFeatured: false
    },
    {
      quote: "Muy buen trabajo, muy prolijo y cumplidor. Lo llamé y enseguida vino y resolvió. Súper recomendable.",
      author: "Maria Gabriela Otero",
      service: "Mantenimiento General",
      isFeatured: false
    },
    {
      quote: "Trabajo bien hecho, con seriedad y puntualidad. Además, ¡un domingo!",
      author: "Silvio Geisinger",
      service: "Urgencia Domingo",
      isFeatured: false
    }
  ];
