...
export function Services() {
  const services = [
    {
      index: "01",
      title: "Instalaciones y Reparaciones",
      description: "Instalaciones eléctricas nuevas y reparaciones en casas, apartamentos y comercios. Diagnóstico claro antes de empezar cualquier trabajo.",
      tags: ["Instalaciones", "Reparaciones", "Casas", "Comercios"],
      waMessage: "Hola Milton, me gustaría consultar por *Instalaciones y Reparaciones*."
    },
    {
      index: "02",
      title: "Tableros Eléctricos",
      description: "Armado, revisión y normalización de tableros eléctricos, con protecciones bien calibradas y todo rotulado para un corte rápido y seguro.",
      tags: ["Tableros", "Normalización", "Protecciones"],
      waMessage: "Hola Milton, necesito información sobre *Tableros Eléctricos*."
    },
    {
      index: "03",
      title: "Cargadores para Autos Eléctricos",
      description: "Instalación de cargadores domiciliarios para autos eléctricos, con la potencia y protecciones que necesita este tipo de instalación.",
      tags: ["Autos eléctricos", "Cargadores", "Instalación"],
      waMessage: "Hola Milton, quiero cotizar la *instalación de un cargador para auto eléctrico*."
    },
    {
      index: "04",
      title: "Emergencias y Asesoramiento UTE",
      description: "Atención de emergencias por cortes de luz, y asesoramiento eléctrico para trámites ante UTE.",
      tags: ["Cortes de luz", "Emergencias 24hs", "Asesoramiento UTE"],
      waMessage: "Hola Milton, tengo una *emergencia eléctrica* y necesito ayuda."
    }
  ];
