        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            >
              ...
              <span>Maldonado • Punta del Este • Emergencias 24hs</span>
            </motion.div>
            ...
            >
              ...
              <span className="relative inline-block whitespace-nowrap text-ink z-10">
                <span className="relative z-10">en Maldonado</span>
            ...
            >
              <span className="relative inline-block text-ink z-10 font-extrabold mr-1">
                <span className="relative z-10">Milton Sardella</span>
                <span className="absolute left-0 right-0 bottom-[2px] h-[0.25em] bg-gold-soft rounded-sm -z-10" />
              </span>{" "}
              resuelve instalaciones, reparaciones y emergencias eléctricas en casas y comercios. <b>Respuesta rápida, presupuesto claro y también instalación de cargadores para autos eléctricos.</b>
            </motion.p>
            ...
            >
              ...
              <span>5.0 / 70 reseñas en Google</span>
          ...
          <div className="lg:col-span-5 relative flex justify-center z-10">
            ...
            >
              ...
              <div className="relative aspect-[1/1.05] rounded-3xl overflow-hidden bg-bg-tint border border-border-subtle shadow-2xl">
                <img
                  src="./img/tablero_moderno.jpg"
                  alt="Tablero eléctrico instalado por Milton Sardella en Maldonado"
