...
export function Gallery() {
  const images = [
    {
      src: "./img/tablero_antes_despues.jpg",
      alt: "Tablero eléctrico antes y después de la normalización",
      tag: "Antes y Después"
    },
    {
      src: "./img/tablero_interior_01.jpg",
      alt: "Tablero eléctrico armado con protecciones calibradas",
      tag: "Tableros"
    },
    {
      src: "./img/tablero_cableado.jpg",
      alt: "Cableado eléctrico prolijo y rotulado",
      tag: "Cableados"
    },
    {
      src: "./img/tablero_interior_02.jpg",
      alt: "Tablero eléctrico moderno instalado por Milton Sardella",
      tag: "Tableros"
    }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        ...
        <div className="max-w-2xl mb-16 space-y-4">
          ...
          <p className="text-muted text-base sm:text-lg font-light leading-relaxed max-w-[65ch]">
            Tableros y trabajos reales ejecutados en Maldonado y Punta del Este.
          </p>
        </div>
