  ...
  const faqs = [
    {
      ...
      a: "Sí, Milton atiende emergencias eléctricas (cortes de luz, fallas urgentes) en Maldonado y Punta del Este."
    },
    {
      q: "¿Instalan cargadores para autos eléctricos?",
      a: "Sí, Milton instala cargadores domiciliarios para autos eléctricos, con las protecciones y la potencia adecuadas para este tipo de instalación."
    },
    {
