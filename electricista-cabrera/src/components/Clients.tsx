...
export function Clients() {
  ...
  const reviews = [
    {
      quote: "Excelente servicio. Nos realizó toda la instalación eléctrica de nuestro local, quedó impecable y con precios accesibles. ¡Recomiendo!",
      author: "Sofia Cabrera",
      service: "Instalación de Local Comercial",
      isFeatured: true
    },
    {
      quote: "Muy recomendable. Nos realizó la instalación completa de casa y trabajo. Todo perfecto y muy prolijo.",
      author: "Ruben López",
      service: "Instalación Completa",
      isFeatured: false
    },
    {
      quote: "Muy responsable. Nos realizó toda la conexión eléctrica a nuevo y quedó impecable. Muy recomendable.",
      author: "Florencia Saavedra",
      service: "Conexión Eléctrica Nueva",
      isFeatured: false
    },
    {
      quote: "Responsabilidad y eficacia al mejor precio. Totalmente recomendable. Seguiremos trabajando con usted.",
      author: "Schubert Sanchez",
      service: "Servicio Recurrente",
      isFeatured: false
    },
    {
      quote: "¡Excelente trabajo! Recomiendo totalmente.",
      author: "Camila López",
      service: "Trabajo Recomendado",
      isFeatured: false
    },
    {
      quote: "Me encantó el trabajo que hizo. La verdad, muchas gracias.",
      author: "Renzo Pintos",
      service: "Buen Trabajo",
      isFeatured: false
    },
    {
      quote: "Excelente trabajo, lo recomiendo mucho.",
      author: "Serena Silva",
      service: "Trabajo Recomendado",
      isFeatured: false
    },
    {
      quote: "Muy conforme con el servicio. ¡Muchas gracias!",
      author: "Julieta Rodriguez",
      service: "Servicio Conforme",
      isFeatured: false
    },
    {
      quote: "Excelentes trabajos, muy recomendable.",
      author: "Nedda Mechlovits",
      service: "Trabajos Recomendables",
      isFeatured: false
    },
    {
      quote: "¡Excelente servicio!",
      author: "Raibelt Baptista",
      service: "Excelente Servicio",
      isFeatured: false
    },
    {
      quote: "Excelente trabajo.",
      author: "Nahiara Sauco",
      service: "Buen Trabajo",
      isFeatured: false
    },
    {
      quote: "Gran profesional en su trabajo.",
      author: "Carlos Amaral",
      service: "Profesionalismo",
      isFeatured: false
    }
  ];
        ...
        <div className="grid md:grid-cols-12 gap-8 md:gap-10 items-start">
          ...
          <div className="md:col-span-4 space-y-4 text-left md:border-r border-border-subtle md:pr-8">
            ...
            <div className="flex items-center gap-2 font-mono text-xs text-muted pt-2">
              ...
              <span>12 opiniones en Google</span>
            </div>
