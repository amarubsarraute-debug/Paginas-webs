        ...
        <div className="bg-paper rounded-3xl border border-border-subtle p-8 sm:p-12 lg:p-16 flex flex-col lg:flex-row gap-12 items-center shadow-lg">
          ...
          <div className="lg:w-1/2 space-y-6">
            ...
            <p className="text-base sm:text-lg text-muted font-light leading-relaxed">
              Electricista Cabrera ofrece el respaldo profesional necesario para certificar instalaciones, solicitar nuevos medidores y realizar aumentos de potencia. No hacemos arreglos provisorios; trabajamos bajo normativas de UTE para asegurar la vigencia y seguridad de tu instalación.
            </p>
          </div>
