  ...
  const services = [
    {
      ...
      waMessage: "Hola Nicolas - Electricista habilitado por UTE, me gustaría consultar por *Instalaciones y Obras*."
    },
    {
      index: "02",
      ...
      waMessage: "Hola Nicolas - Electricista habilitado por UTE, necesito información sobre *Tableros y Firma de UTE*."
    },
    {
      index: "03",
      ...
      waMessage: "Hola Nicolas - Electricista habilitado por UTE, quiero cotizar un trabajo de *Iluminación y Reformas*."
    },
    {
      index: "04",
      ...
      waMessage: "Hola Nicolas - Electricista habilitado por UTE, necesito un servicio de *Mantenimiento y Reparación* por una falla."
    }
  ];
