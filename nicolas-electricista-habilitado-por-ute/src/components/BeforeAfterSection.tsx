        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 w-full flex justify-center order-2 lg:order-1">
            ...
            >
              <BeforeAfter
                ...
                alt="Tablero eléctrico normalizado por Nicolas - Electricista habilitado por UTE"
              />
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-6 space-y-6 order-1 lg:order-2 text-left">
            ...
            <p className="text-muted text-base sm:text-lg font-light leading-relaxed">
              Mirá el cambio real de un trabajo de normalización de Nicolas - Electricista habilitado por UTE. De un cableado caótico y propenso a recalentamientos, a un tablero ordenado, seguro y certificado bajo normas UTE.
            </p>
